...
describe Nummy::Enum do
  describe ".each_pair" do
    it "is an alias for .each_const_pair" do
      # can't use our assert_aliased helper here because the methods have different
      # owners, and are therefore not equal.
      orig_method = Nummy::ConstEnumerable.instance_method(:each_const_pair)
      new_method = Nummy::Enum.singleton_class.instance_method(:each_pair)
